...
export default function MediaPage() {
  ...
  const videos = [
    {
      id: "video1",
      title: "Salvation Crusade in Benue State",
    ...
    {
      id: "video2",
      title: "Pastor Training Workshop",
      youtubeUrl: "https://www.youtube.com/embed/dQw4w9WgXcQ",
      date: "April 22, 2023",
      category: "training",
    },
    ...
    {
      id: "video4",
      title: "Testimony from Kaduna Revival",
      youtubeUrl: "https://www.youtube.com/embed/dQw4w9WgXcQ",
      date: "June 5, 2023",
  ...
  const photos = [
    ...
    {
      id: "photo2",
      title: "Salvation Crusade in Enugu",
      imageUrl: "/placeholder.svg?height=300&width=400",
      date: "March 28, 2023",
      category: "crusades",
    },
      ...
      <Tabs defaultValue="videos" className="w-full mb-12">
        ...
        <TabsContent value="videos" className="space-y-8">
          ...
          <div className="text-center mt-8">
            <p className="text-gray-600 italic">More videos are added regularly. Check back soon for updates.</p>
          </div>
        </TabsContent>
        ...
        <TabsContent value="photos" className="space-y-8">
          ...
          <div className="text-center mt-8">
            <p className="text-gray-600 italic">More photos are added regularly. Check back soon for updates.</p>
          </div>
        </TabsContent>
      </Tabs>
    </div>
