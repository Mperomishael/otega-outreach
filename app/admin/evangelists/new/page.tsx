...
export default function NewEvangelistPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      // Save to Firestore
      await addDocument(COLLECTIONS.EVANGELISTS, evangelistData)
      ...
      setError(error instanceof Error ? error.message : "Failed to add evangelist. Please try again.")
      setUploadProgress(0)
    } finally {
          ...
          <main className="flex-1 p-6">
            <div className="space-y-6">
              <div className="flex items-center gap-4">
                ...
                <h1 className="text-2xl font-bold">Add New Evangelist</h1>
              </div>
              ...
              <div className="bg-white p-6 rounded-lg shadow-sm">
                <form onSubmit={handleSubmit} className="space-y-6">
                  ...
                  {isSubmitting && (
                    <div className="mb-4">
                      <p className="text-sm font-medium text-gray-700 mb-1">Saving evangelist profile...</p>
                  ...
                  <div className="flex justify-end gap-3">
                    ...
                    >
                      {isSubmitting ? "Saving..." : "Save Evangelist"}
                    </button>
                  </div>
                </form>
              </div>
